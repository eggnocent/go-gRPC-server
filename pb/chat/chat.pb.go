...
const file_chat_chat_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId2\xbb\x01\n" +
	"\vChatService\x126\n" +
	"\vSendMessage\x12\x11.chat.ChatMessage\x1a\x12.chat.ChatResponse(\x01\x12B\n" +
	"\x0eReceiveMessage\x12\x1b.chat.ReceiveMessageRequest\x1a\x11.chat.ChatMessage0\x01\x120\n" +
	"\x04Chat\x12\x11.chat.ChatMessage\x1a\x11.chat.ChatMessage(\x010\x01B\x1eZ\x1cgrpc-course-protobuf/pb/chatb\x06proto3"
...
var file_chat_chat_proto_goTypes = []any{
	...
	(*ReceiveMessageRequest)(nil), // 2: chat.ReceiveMessageRequest
}
var file_chat_chat_proto_depIdxs = []int32{
	0, // 0: chat.ChatService.SendMessage:input_type -> chat.ChatMessage
	2, // 1: chat.ChatService.ReceiveMessage:input_type -> chat.ReceiveMessageRequest
	0, // 2: chat.ChatService.Chat:input_type -> chat.ChatMessage
	1, // 3: chat.ChatService.SendMessage:output_type -> chat.ChatResponse
	0, // 4: chat.ChatService.ReceiveMessage:output_type -> chat.ChatMessage
	0, // 5: chat.ChatService.Chat:output_type -> chat.ChatMessage
